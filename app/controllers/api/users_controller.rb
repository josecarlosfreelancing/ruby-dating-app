class Api::UsersController < ApplicationController
  ...
  def create
    ...
    mailchimp = MailchimpWrapper.new(Rails.application.secrets.mailchimp_api_key)
    list_id = "1267eed985"
    subject = "New User Sign Up"
    from_name = "Sinder"
    from_email = "ghostny1977@gmail.com"
    content = "New user #{user.email} signed up to the app"

    mailchimp.send_email(list_id, subject, from_name, from_email, content)
